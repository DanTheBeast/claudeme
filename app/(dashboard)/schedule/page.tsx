    ...
    <div className="pb-24">
      ...
      <main className="px-5 pt-5 flex flex-col gap-3">
        ...
        {loading ? (
          ...
          <>
            {windows.length === 0 && (
              <div className="bg-white rounded-[22px] p-6 shadow-sm border border-gray-100 text-center anim-fade-up">
                <div className="w-12 h-12 rounded-full bg-callme-50 flex items-center justify-center mx-auto mb-3">
                  <Calendar className="w-5 h-5 text-callme" />
                </div>
                <h3 className="font-display text-base font-bold mb-1">No availability set</h3>
